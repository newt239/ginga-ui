  ...
  render: () => (
    ...
    >
      ...
      >
        ...
        <AccordionContent value="item-1">
          This accordion has custom styles applied to demonstrate the styling
          flexibility.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
...
export const Compact: Story = {
  render: () => (
    <Accordion type="single" defaultValue={["item-1"]}>
      <AccordionItem value="item-1">
        <AccordionTrigger value="item-1" style={{ padding: "0.5rem" }}>
          Compact Version
        </AccordionTrigger>
        <AccordionContent value="item-1" style={{ padding: "0.5rem" }}>
          This is a compact version with reduced padding.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
